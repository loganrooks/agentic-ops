...
## Notes
- If a target repo doesn't yet have CodeRabbit installed, the PR can still merge after CI green + maintainer review (no central enforcement). Flag the missing CodeRabbit setup as a follow-up issue in the target repo and link it from the onboarding PR body.
